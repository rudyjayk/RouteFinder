...
import 'findgamesmapuserlibrary.dart';
import 'findgames.dart';
import 'createscreen.dart';
import 'settingScreen.dart';

class FindGamesUserLibrary extends StatefulWidget {
  Gameutil _gameutil;
  FindGamesUserLibrary(this._gameutil);
  @override
  _FindGamesUserLibraryState createState() => _FindGamesUserLibraryState(_gameutil);
}

class _FindGamesUserLibraryState extends State<FindGamesUserLibrary> {
  _FindGamesUserLibraryState(this._gameutil);
  ...
  Widget build(BuildContext context) {
    if(_firstBuild) {
      _firstBuild = false;
      _map = FindGamesMapUserLibrary(_gameutil); 
    }
    return Scaffold(
