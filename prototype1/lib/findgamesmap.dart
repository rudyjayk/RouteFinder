...
class FindGamesMap extends StatefulWidget {
  Gameutil _gameutil;
  FindGamesMap(this._gameutil);
  @override
  _FindGamesMapState createState() => _FindGamesMapState(_gameutil);
}

class _FindGamesMapState extends State<FindGamesMap> {
  _FindGamesMapState(this._gameutil);
  Gameutil _gameutil;
...
// geolocator. Received assitance from pub.dev/packages/geolocator
  ...
  Future<List<Game>> _getAllRouteGames() async {
    ...
    games = await _gameutil.db.getAllGameRoutes();
    return games;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Griffen used this strategy in his software engineering project for 
      // a loading screen and was able to apply it to this project. 
